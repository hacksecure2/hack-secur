...
export const Footer = () => {
  return (
    <footer className="fixed z-0 h-[650px] md:h-[450px] lg:h-[430px] flex justify-center bottom-0 text-center w-full text-8xl bg-black text-[#f9f9f9] overflow-hidden">
      <h1 className="absolute bottom-0 left-1/2 -translate-x-1/2 text-[20vw] md:text-[15vw] font-extrabold text-white/5 pointer-events-none select-none whitespace-nowrap">
        Hack Secure
      </h1>

      <div className="relative mt-30 md:mt-10 flex flex-col  justify-center items-center md:gap-8 max-w-7xl mx-auto px-8 py-16 md:py-24">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 text-xs md:text-sm text-slate-400">
          <div className="flex flex-col">
            <div className="font-bold mb-4">Company</div>
            <Link to="" className="py-1 hover:text-white hover:underline">
              About Us
            </Link>
            <Link to="" className="py-1 hover:text-white hover:underline">
              Our Team
        ...
        <SocialHandles />
        <div className="text-xs text-[#f9f9f9]/40">
          © 2025 HackSecure. All rights reserved.
        </div>
      </div>
    </footer>
